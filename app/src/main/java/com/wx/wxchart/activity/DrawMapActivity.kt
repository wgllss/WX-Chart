...
class DrawMapActivity : ComponentActivity() {
            ...
            setContent {
                WXChart {
                    baseUI2({ paddingvalues ->
                        drawMap(paddingvalues, viewModel)
                    }, {
                        finish()
                    })
                }
...
@Composable
fun drawMap(innerPadding: PaddingValues = PaddingValues(0.dp), viewDModel33: MapViewModel = MapViewModel().apply { setData() }) {
